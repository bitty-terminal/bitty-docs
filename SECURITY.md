...
[GitHub Security Advisory](https://github.com/bitty-terminal/bitty-docs/security/advisories/new).
...
- Security requirements for future Bitty implementations live in the canonical
  security corpus under `docs/security/`; that corpus takes precedence over
  historical notes when statements conflict.
