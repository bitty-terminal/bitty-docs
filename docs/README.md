...
| [CLI](interfaces/cli.md)                                  | Candidate command/action registry, CLI grammar, IPC, and automation contract (draft wire/transport contract in [IPC and Agent RFC](specifications/ipc-agent-rfc.md) for OQ-018). |
