...
is **Pre-alpha / Engineering Milestones M1-M8** (2026-09-08, `bitty` `7048139`
previous `1835175` baseline `de134ec`, 18 crates,
...
`Implemented` (compat-lab/perf hardening and UX wave through `7048139` plus semantic-terminal P1-P5 `Implemented`-only plus experimental single-window slice)
...
| [Release Ladder](product/release-ladder.md)                                                            | Pre-alpha / Engineering Milestones M1-M8 mapping of the v0.1-v1.0 maturity ladder to the 18-crate workspace and `Implemented`/`Verified` lifecycle (2026-09-08, `7048139`).                                                                                                                                                                                                                                                                                                                                                |
...
| [Repository bootstrap](development/repository-bootstrap.md)     | Accepted zero-functionality Core and website scaffold contract plus implementation validation gates (18 crates `7048139` now `Implemented` but not yet `Verified`). |
...
| Document                                                        | Purpose                                                                                                                                                        |
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Repository map](project/repository-map.md)                     | Local/remote topology, repository ownership, and current initialization state (18 crates `7048139`, Website Delivery OQ-023 and Governance OQ-024 `Accepted`). |
...
| [Phase A TODO](../TODO.md)                                                                           | Pre-alpha status reconciliation and hardening work (2026-09-08, `7048139`).            |
...
| Implemented                           | Demonstrated by code, tests, or release evidence in the owning repository (`bitty` `7048139`, 18 crates, compat-lab/perf hardening plus experimental `c0aadd2`/`7e3104d`/`a8735d0` `Implemented` but not yet `Verified`). |
...
At the 2026-09-08 snapshot (`7048139`, baseline `de134ec` previous `1835175`),
