...
| [Technology strategy](project/technology-strategy.md)           | Accepted language/platform direction and implementation choices (21 crates, `bitty-lua` `piccolo` 0.3.3 `Accepted`).                                                   |
