...
| [Theme presets](configuration/themes.md)                  | Draft built-in theme preset catalog: selection keys and aliases, dark/light preset families, provenance, unsupported custom themes, and open questions; the wider catalog is being implemented in `bitty` `CTX-0350` and is not yet shipped.                                                                             |
