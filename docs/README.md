...
state at a glance (snapshot `2026-09-19`):
...
| [Repository bootstrap](development/repository-bootstrap.md)                                                  | Accepted zero-functionality Core and website scaffold contract plus implementation validation gates (21 crates `23c3eb6` now `Implemented` but not yet `Verified`).                                                 |
...
| Document                                                        | Purpose                                                                                                                                                                |
| --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Repository map](project/repository-map.md)                     | Local/remote topology, repository ownership, and current initialization state (21 crates `23c3eb6`, Website Delivery OQ-023 and Governance OQ-024 `Accepted`).         |
...
| [Phase A TODO](../TODO.md)                                                                           | Pre-alpha status reconciliation and hardening work (2026-09-19, `23c3eb6`).            |
...
| Implemented                           | Demonstrated by code, tests, or release evidence in the owning repository (`bitty` `23c3eb6`, 21 crates, compat-lab/perf hardening plus scrollbar overlay plus workspace/frameHash wave plus the `v0.0.20` plugin-runtime, Kitty-graphics, decoration, and config-matrix wave plus post-release execution-supervisor, IPC-service, and security foundations with experimental `c0aadd2`/`7e3104d`/`a8735d0` `Implemented` but not yet `Verified`). |
...
At the 2026-09-19 snapshot (`23c3eb6`, baseline `de134ec` previous `bea338d`),
