...
| [CLI](interfaces/cli.md)                                  | Candidate command/action registry, CLI grammar, IPC, and automation contract (draft CLI contract in [CLI Contract RFC](specifications/cli-contract-rfc.md) for OQ-017; draft wire/transport contract in [IPC and Agent RFC](specifications/ipc-agent-rfc.md) for OQ-018). |
