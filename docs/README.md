...
| Candidate / Draft                     | A proposal to investigate, compare, or prototype. Spec remains `Draft` until reviewed `Accepted`; 6 `Draft` specs remain (see `specifications/README.md` prioritization).                                                |
