...
and the [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/lua-runtime-rfc.md) without
...
- Deciders: project initiator (DEC-001), security-auditor persona (audit gate
  per [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/lua-runtime-rfc.md) security review
...
- [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/lua-runtime-rfc.md) — Accepted 2026-08-27 sandbox stdlib baseline module search diagnostics Open items
- [Isolation Resource RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/isolation-resource-rfc.md) — RC-1 and RC-2, FS-1 through FS-9, attack cases AT-IR-004 through AT-IR-007
