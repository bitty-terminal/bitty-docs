...
- [Specifications index](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/README.md) - the RFC moved from
  the Draft table to the accepted table.
- [Plugin system](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/extensibility/plugin-system.md) - validation note points
  at the accepted RFC.
...
- Draft RFC `bitty-plugins/specifications/plugin-host-runtime-rfc.md` (504 lines) authored
