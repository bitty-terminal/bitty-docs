...
| [ADR 0009 - Repository Metadata and GitHub Baseline](ADR-0009-repository-metadata-baseline.md)                     | Proposed | Byte-identical, parameterized, and per-repository metadata/.github tiers; required-check naming; action pinning and rust channel rules                                               |
