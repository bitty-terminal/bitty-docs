...
- Runtime plugin host bridge, per-plugin VM lifecycle, source resolution and
  staging, and host-service wiring. (Open: [OQ-033](open-questions.md),
  [OQ-034](open-questions.md), and [OQ-035](open-questions.md); proposed
  bounded resolution in the Draft
  [Plugin Host Runtime RFC](../specifications/plugin-host-runtime-rfc.md) from
  bitty `CTX-0324` D4/P0 Gaps A/B/C; requires ADR ratification.)
