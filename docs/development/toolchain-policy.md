...
| `bitty-plugin-template` | Bun 1.4.0                                                                                | bun             | `just check` | lefthook 2.1.10, commitlint 21.2.2, prettier 3.9.6, markdownlint-cli2 0.23.2 mirrored in justfile variables and package.json/bun.lock                                                                                            |
