...
package lifecycle model (OQ-021), Lua runtime model (OQ-009), and rich presentation model (OQ-008/OQ-015/OQ-016) now `Accepted`
(2026-08-28); isolation VM budgets (RC-1/RC-2/Global) now enforced measured via
