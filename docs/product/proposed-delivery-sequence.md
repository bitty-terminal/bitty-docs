...
package lifecycle model (OQ-021), Lua runtime model (OQ-009), rich presentation model (OQ-008/OQ-015/OQ-016), and isolation resource model (OQ-014) now `Accepted`
(2026-08-28); isolation VM budgets (RC-1/RC-2/Global) now enforced measured and accepted via
CTX-0040 (21 + 15 headless tests, `just check` 92 files 0 issues, `cargo check --target x86_64-pc-windows-gnu` pass). No entry below self-accepts its
contract:
