...
description: Maps the Pre-alpha / Engineering Milestones M1-M8 stage (18 crates 1835175, 32 OQs Accepted, release v0.0.19) to the v0.1-v1.0 maturity ladder and the Implemented/Verified lifecycle
category: product
audience: maintainer
...
- Stage: **Pre-alpha / Engineering Milestones M1-M8** as of 2026-09-07 (`bitty` `1835175`,
  previous `e8a7b76`, baseline `de134ec`, 18 crates, 32 OQs `Accepted`, release `v0.0.19`).
