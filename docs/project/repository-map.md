...
| `bitty-ai/`                            | `https://github.com/bitty-terminal/bitty-ai`              | Initial snapshot pushed; `main` protected (squash-only)         | `Quality gates`, `MSRV 1.85 check`, `Linux`, `Windows`, `macOS`, `Supply chain`                                                                                                                               |
...
| `bitty-plugins/activity/`              | `https://github.com/bitty-terminal/activity`              | Initial snapshot pushed; `main` protected (squash-only)         | `Quality gates`, `Lint GitHub Actions workflows`, `Analyze (actions)`, `Analyze (javascript-typescript)`, `CodeQL`                                                                                            |
