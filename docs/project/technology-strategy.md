...
| Primary configuration language | Lua                                                        | Accepted working direction; model, layer, merge, and reload contracts accepted in [Configuration Model RFC](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/configuration-model-rfc.md) (OQ-010); Lua runtime, sandbox, and diagnostics contracts accepted in [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/runtime/lua-runtime-rfc.md) (OQ-009, 2026-08-27) |
...
| --------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lua runtime           | Lua 5.4 plus vendored `mlua` (Config VM); `piccolo` plugin VM with Phodopus as the successor path | Sandbox, restricted-library, and diagnostics contracts accepted in [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/runtime/lua-runtime-rfc.md) (OQ-009, 2026-08-27); exact pins, audit, and GC/budget tuning accepted in [ADR-0005](../decisions/adrs/ADR-0005-lua-pins-and-stdlib.md) (OQ-030, 2026-08-29); the plugin-VM successor direction is [ADR 0012](../decisions/adrs/ADR-0012-phodopus-runtime.md) (Phodopus, 2026-09-20), with `bitty-lua` migration deferred until the runtime is usable |
| Primary configuration | `init.lua` to declarative `ConfigPlan`                                                            | Accepted: schema, merge, reload, and project-trust contracts defined in [Configuration Model RFC](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/configuration-model-rfc.md) (OQ-010); Lua runtime, sandbox, and diagnostics contracts accepted in [Lua Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/runtime/lua-runtime-rfc.md) (OQ-009, 2026-08-27)                                                                                                                  |
...
The MCP tool surface (hosted in the `bitty-mcp` repository until its
2026-09-14 archival; since then covered by `bitty-ai`) should be an adapter for
the debug and command protocol. Core knows only the structured protocol; it
does not know MCP, model providers, prompts, or tokens.
...
External reference material is maintained outside this canonical corpus. See
[Reference Project Register](reference-projects.md) for the self-contained,
non-normative comparison boundary and pinned upstream revisions.
...
- Accepted: [Terminal State RFC](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/terminal-state-rfc.md)
