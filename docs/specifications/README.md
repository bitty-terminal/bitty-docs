...
| [UI Extensibility Architecture](ui-extensibility-architecture.md)                       | OQ-041, OQ-043, OQ-044, OQ-045, OQ-049 (candidate review) | Draft    |
...
| [UI Extensibility Architecture](ui-extensibility-architecture.md)           | OQ-041/OQ-043/OQ-044/OQ-045/OQ-049, appearance/panel extension review | Draft  | none (design review, no implementation, docs CTX-0157; OQ-042 background-image contract accepted in RFC-0001)      | P1 — panel/appearance extensibility     |
