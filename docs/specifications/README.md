...
Review note (2026-08-31, reconciled per CTX-0119, `bitty` `a8735d0` chain `d4d75e9 -> c0aadd2 -> 7e3104d -> a8735d0`, `R-004` `Open`, `R-005`/`R-006`/`R-007` `Mitigated`, experimental `c0aadd2`/`7e3104d`/`a8735d0` `Implemented` not `Verified`): the Configuration Model RFC targeting OQ-010,
...
remain `Accepted` as recorded in the [decision register](../decisions/index.md); six drafts remain `Draft` (not `Accepted`/`Verified`) with experimental code only for Input/Text and none for Panel pre-study.
