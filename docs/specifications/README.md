...
| [UI Extensibility Architecture](ui-extensibility-architecture.md)                       | OQ-041, OQ-042, OQ-043, OQ-044 (candidate review) | Draft    |
...
| [UI Extensibility Architecture](ui-extensibility-architecture.md)           | OQ-041..044, appearance/panel extension review    | Draft  | none (design review, no implementation, docs CTX-0157)                                                             | P1 — panel/appearance extensibility     |
