...
| [Plugin Host Runtime RFC](plugin-host-runtime-rfc.md)                       | plugin host bridge, VM lifecycle, source staging, host-service wiring (OQ-033/034/035) | Draft  | none yet                                                                                                           | P0 — unblocks bitty CTX-0324            |
